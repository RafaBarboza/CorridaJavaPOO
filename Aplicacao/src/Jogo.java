			...
			if(jogador1.vez == true) {
				...
				try {
					...
					if(arrayPosicao[valorJ1].contains("|?|")) {
						...
						escreveJogadas("Jogador 1 ", jogador1.getNome() + " caiu na casa especial e voltou 3 casa(s).");
			...
			if(jogador2.vez == true) {			
				...
				try {
					...
					if(arrayPosicao[valorJ2].contains("|?|")) {
						...
						escreveJogadas("Jogador 2 ", jogador2.getNome() + " caiu na casa especial e voltou 3 casa(s).");
